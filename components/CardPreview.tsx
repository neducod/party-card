  ...
  function CardPreview({ state }, ref) {
    ...
    const backgroundStyle: React.CSSProperties =
      style.backgroundMode === "gradient"
        ? { background: `linear-gradient(${style.gradient.angle}deg, ${style.gradient.from}, ${style.gradient.to})` }
        : style.backgroundMode === "image" && style.backgroundImage
        ? {
      ...
      >
        ...
        {style.backgroundMode === "image" && style.backgroundImage && (
          <div
            ...
            style={{ backgroundColor: `rgba(0,0,0,${style.backgroundImageDim})` }}
          />
        )}
